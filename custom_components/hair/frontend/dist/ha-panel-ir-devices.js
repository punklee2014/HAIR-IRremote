                ...
                ${e?j`
                        ...
                        ${"protocol"===this._acControlMode?j`
                                <div class="field">
                                    ...
                                    <select
                                        .value=${this._irProtocol||""}
                                        @change=${e=>this._irProtocol=e.target.value||null}
                                    >
